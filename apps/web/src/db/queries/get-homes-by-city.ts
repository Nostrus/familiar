...
export type HomeResult = typeof homes.$inferSelect;

export const getHomesByCity = cache(async (filters: HomesByCityFilters = {}) => {
  const conditions = [];
  ...
  const grouped: Record<string, HomeResult[]> = {};
